"""
AI in Retail Business - Smarter Stock Recommender (Seasonal Menu Version with Loop)
...
It will keep running until the user chooses to stop.
"""
...
while True:
    ...
    # === 12. Ask if user wants to continue ===
    again = input("Would you like to analyze another season? (yes/no): ").strip().lower()
